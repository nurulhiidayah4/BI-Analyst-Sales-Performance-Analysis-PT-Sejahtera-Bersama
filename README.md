# BI-Analyst-Sales-Performance-Analysis-PT-Sejahtera-Bersama
...
1. **Data Integration (SQL):** Menggabungkan 4 tabel utama (Customers, Orders, Products, dan Category) menggunakan SQL JOIN untuk membentuk satu tabel master.
2. **Data Cleaning:** Memastikan data harga, kuantitas, dan tanggal sudah dalam format yang benar.
3. **Data Visualization (Looker Studio):** Membuat dashboard interaktif untuk memvisualisasikan 7 metrik utama sesuai permintaan bisnis.
...
## 🔗 Tautan Terkait
* **Dashboard Looker Studio:** [# BI Analyst Project: Sales Performance Dashboard - PT Sejahtera Bersama
...
---
*Proyek ini dikembangkan sebagai bagian dari Muamalat BI Analyst Virtual Internship Experience.*
